...
/* Hunt and Peck a BIG to a curve point
    ...
    public static ECP map2point(FP h) {
        ...
        if (CONFIG_CURVE.CURVETYPE == CONFIG_CURVE.EDWARDS) { // Elligator 2 - map to Montgomery, place point, map back
            FP X1 = new FP();
            FP X2 = new FP();
            FP t = new FP(h);
            FP w = new FP();
...
*/
            ...
            if (CONFIG_FIELD.MODTYPE == CONFIG_FIELD.GENERALISED_MERSENNE) { // GOLDILOCKS isogeny
                t.copy(X1);
                t.sqr();
                w.copy(t);
                w.add(one);
