...
import static jssi.ursa.credential.util.BigNumber.LARGE_E_START_VALUE;
...
public class ProofVerifier {
    ...
    public boolean verify(Proof proof, BigInteger nonce) throws CryptoException {
        ...
        BigInteger c_hver = new BigInteger(1, CredentialHelper.hash(values));
    ...
    private static NonRevocProofTauList verifyNonRevocationProof(
        ...
        NonRevocProofTauList t_hat_expected_values = CredentialHelper.createTauListExpectedValues(
                credentialRevocationPublicKey,
                revocationRegistry,
                revocationPublicKey,
                proof.c_list);
        NonRevocProofTauList t_hat_calc_values = CredentialHelper.createTauListValues(
                credentialRevocationPublicKey,
                revocationRegistry,
                proof.x_list,
                proof.c_list);
            ...
            SubProofRequest subProofRequest)
    {
        ...
        BigInteger t1 = CredentialHelper.calc_teq(
                credentialPrimaryPublicKey,
