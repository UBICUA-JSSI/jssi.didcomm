...
public class HKDFTest {
    ...
    public void vector_test() {
        ...
        byte[] actualOutput = new HKDF().deriveSecrets(ikm, salt, info, 42);
        //assertTrue(Arrays.equals(okm, actualOutput));
        byte[] actualOutput1 = new SignalHKDF().deriveSecrets(ikm, salt, info, 42);
        assertTrue(Arrays.equals(actualOutput1, actualOutput));
    }

    @Test
    public void vectorLong_test() {
        ...
        byte[] actualOutput = new SignalHKDF().deriveSecrets(ikm, salt, info, 82);
        assertTrue(Arrays.equals(okm, actualOutput));
    }
}
