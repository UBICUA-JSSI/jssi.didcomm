...
import jssi.mls.state.store.InMemoryIdentityKeyStore;
import jssi.mls.state.store.WalletController;
import jssi.mls.util.KeyHelper;
import org.libsodium.jni.SodiumException;

public class SSIIdentityKeyStore extends InMemoryIdentityKeyStore {

    public SSIIdentityKeyStore() throws SodiumException {
        super(generateIdentityKeyPair(), generateRegistrationId());
    }

    public SSIIdentityKeyStore(ProtocolAddress address) throws SodiumException {
