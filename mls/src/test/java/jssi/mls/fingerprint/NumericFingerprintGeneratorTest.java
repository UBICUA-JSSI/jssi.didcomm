...
public class NumericFingerprintGeneratorTest {
    ...
    public NumericFingerprintGeneratorTest(){
        NaCl.sodium();
    }

    @Test
    public void vectorsVersion1_test() throws Exception {
        IdentityKey aliceIdentityKey = new IdentityKey(ALICE_IDENTITY);
        IdentityKey bobIdentityKey = new IdentityKey(BOB_IDENTITY);
    ...
    @Test
    public void vectorsVersion2_test() throws Exception {
        IdentityKey aliceIdentityKey = new IdentityKey(ALICE_IDENTITY);
        IdentityKey bobIdentityKey = new IdentityKey(BOB_IDENTITY);
        byte[] aliceStableId = "+14152222222".getBytes();
        byte[] bobStableId = "+14153333333".getBytes();
    ...
    @Test
    public void matchingFingerprints_test() throws FingerprintVersionMismatchException, FingerprintParsingException, SodiumException {
    ...
    @Test
    public void mismatchingFingerprints_test() throws FingerprintVersionMismatchException, FingerprintParsingException, SodiumException {
        ECKeyPair aliceKeyPair = Curve.generateKeyPair();
        ECKeyPair bobKeyPair = Curve.generateKeyPair();
        ...
        assertNotEquals(bobFingerprint.getDisplayableFingerprint().getDisplayText(), aliceFingerprint.getDisplayableFingerprint().getDisplayText());
    ...
    @Test
    public void mismatchingIdentifiers_test() throws FingerprintVersionMismatchException, FingerprintParsingException, SodiumException {
        ECKeyPair aliceKeyPair = Curve.generateKeyPair();
        ECKeyPair bobKeyPair = Curve.generateKeyPair();
    ...
    @Test
    public void differentVersionsMakeSameFingerPrintsButDifferentScannable_test() throws Exception {
        IdentityKey aliceIdentityKey = new IdentityKey(ALICE_IDENTITY);
        IdentityKey bobIdentityKey = new IdentityKey(BOB_IDENTITY);
        byte[] aliceStableId = "+14152222222".getBytes();
        byte[] bobStableId = "+14153333333".getBytes();
        ...
        assertEquals(aliceFingerprintV2.getDisplayableFingerprint().getDisplayText(), aliceFingerprintV1.getDisplayableFingerprint().getDisplayText());
