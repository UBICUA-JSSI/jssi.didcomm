...
public class SodiumJNI {
  ...
  public final static native int crypto_kdf_derive_from_key(byte[] subkey, int length, int id, byte[] context, byte[] master);
  public final static native void crypto_kdf_keygen(byte[] master);
  ...
  public final static native int crypto_auth_hmacsha256(byte[] mac, byte[] data, int length, byte[] key);
  public final static native int crypto_auth_hmacsha256_verify(byte[] mac, byte[] data, int length, byte[] key);
  ...
  public final static native int crypto_hash_sha256_init(byte[] state);
  public final static native int crypto_hash_sha256_update(byte[] state, byte[] data, int length);
  public final static native int crypto_hash_sha256_final(byte[] state, byte[] hash);
  ...
  public final static native int crypto_sign_ed25519_seed_keypair(byte[] pk, byte[] sk, byte[] seed);
