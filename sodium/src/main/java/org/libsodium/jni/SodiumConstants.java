...
public abstract class SodiumConstants {
    ...
    public final static int CRYPTO_AUTH_HMACSHA256_STATEBYTES = 208;
    ...
    public final static int CRYPTO_SCALARMULT_ED25519_BYTES = 32;
    public final static int CRYPTO_SCALARMULT_ED25519_SCALARBYTES = 32;

    public final static int CRYPTO_KDF_KEYBYTES = 32;
    public final static int CRYPTO_KDF_CONTEXTBYTES = 8;
    ...
    public final static int CRYPTO_HASH_SHA256_BYTES = 32;
    public final static int CRYPTO_HASH_SHA256_STATE = 104;
}
